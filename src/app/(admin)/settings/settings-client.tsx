...
export function SettingsClient({ products }: { products: Product[] }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="min-qty" className="w-full">
        <TabsList>
          <TabsTrigger value="min-qty">Минимални количества</TabsTrigger>
        </TabsList>

        <TabsContent value="min-qty" className="pt-4">
          <Card>
            <CardHeader>
